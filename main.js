...
setTimeout(function() {
	...
	$('.farmingmode').on('click', function() {
		...
		$('.text-center.be-u-m--t4.a.fadeInLeft.a-d-2').append('<div class="bfm-sparks be-user-bar be-u-m--b1"><div class="be-user-bar__inner" style="width: 0%;margin-top: 50px;background: #fff;box-shadow: 0 0 3px rgba(255, 255, 255, 0.5);"></div></div><small class="bfm-sparks-small ng-scope">0 <span class="icon-spark"></span> in 0s</small>');
		sparks = true;
	});
