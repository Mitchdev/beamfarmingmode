...
setTimeout(function() {
	...
	$('.be-channel-page__btns').append('<div class="be-u-m--l1 ng-scope"><button class="md-small md-no-spacing md-button md-ink-ripple"><span onclick="farmingmode();">Farming Mode</span></button></div>');
	setTimeout(function() {
