...
setTimeout(function() {
	...
	$('.be-channel-page__nav__section be-channel-page__btns').append('<div class="be-u-m--l1 ng-scope"><button class="md-raised md-small md-primary md-button ng-scope md-ink-ripple" onclick="farmingmode();"><span>Farming Mode</span></button></div>');
